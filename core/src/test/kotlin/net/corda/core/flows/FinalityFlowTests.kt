...
class FinalityFlowTests {
    ...
    fun setup() {
        ...
        alice = notaryNode.services.identityService.wellKnownPartyFromX500Name(ALICE_NAME)!!
        bob = notaryNode.services.identityService.wellKnownPartyFromX500Name(BOB_NAME)!!
